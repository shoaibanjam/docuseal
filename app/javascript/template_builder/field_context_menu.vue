    ...
    >
      ...
      >
        ...
        <span
          ...
          class="bg-primary-content/10 rounded px-1 leading-3"
          style="font-size: 9px;"
      ...
      <button
        class="field-settings-remove w-full px-2 py-1 rounded-md hover:bg-[#1d2b3e] flex items-center justify-between text-sm text-error"
      ...
      >
        <button
          ...
          class="field-settings-draw-new-area w-full px-2 py-1 rounded-md hover:bg-[#1d2b3e] flex items-center space-x-2 text-sm cursor-pointer"
        ...
        <button
          ...
          class="field-settings-copy-to-all-pages w-full px-2 py-1 rounded-md hover:bg-[#1d2b3e] flex items-center space-x-2 text-sm cursor-pointer"
        ...
        <button
          ...
          class="field-settings-save-as-custom-field w-full px-2 py-1 rounded-md hover:bg-[#1d2b3e] flex items-center space-x-2 text-sm cursor-pointer"
