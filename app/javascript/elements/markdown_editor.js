...
function loadTiptap() {
  return Promise.all([
    ...
    import(
      /* webpackChunkName: "markdown-editor" */ '@tiptap/extension-italic'
    ),
    import(
      /* webpackChunkName: "markdown-editor" */ '@tiptap/extension-paragraph'
    ),
    import(/* webpackChunkName: "markdown-editor" */ '@tiptap/extension-text'),
    import(
      /* webpackChunkName: "markdown-editor" */ '@tiptap/extension-hard-break'
    ),
    import(
      /* webpackChunkName: "markdown-editor" */ '@tiptap/extension-document'
    ),
    import(/* webpackChunkName: "markdown-editor" */ '@tiptap/extension-link'),
    import(
      /* webpackChunkName: "markdown-editor" */ '@tiptap/extension-underline'
    ),
    ...
    import(
      /* webpackChunkName: "markdown-editor" */ '@tiptap/extensions/placeholder'
    ),
  ]).then(
    ([
      core,
    ...
    this.saveHandler = () => {
      ...
      if (inputUrl) {
        this.editor
          ...
          .setLink({ href: this.normalizeUrl(inputUrl) })
          .run();
      }
  ...
  targetable(
    class extends HTMLElement {
      ...
      async connectedCallback() {
        ...
        const placeholderExtension =
          this.dataset.placeholder && Placeholder
            ? Placeholder.configure({ placeholder: this.dataset.placeholder })
            : null;
          ...
          extensions: [
            ...
            Link.extend({
              ...
              HTMLAttributes: {
                ...
                'data-turbo': 'false',
                style:
                  'color: #2563eb; text-decoration: underline; cursor: text;',
              },
            }),
            Underline,
      ...
      updateToolbarState() {
        ...
        this.underlineButton.classList.toggle(
          'bg-base-200',
          this.editor.isActive('underline')
        );
        this.linkButton.classList.toggle(
          'bg-base-200',
      ...
      handleLinkTooltip(editor) {
        ...
        this.linkTooltip.show(
          mark.attrs.href,
          linkStart > start ? linkStart - 1 : linkStart
        );
        this.linkTooltip.currentMark = mark;
      }
